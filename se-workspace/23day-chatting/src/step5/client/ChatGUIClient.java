...
public class ChatGUIClient 
{
	...
	public void startUI() 
	{
		...
		frame.add(sp, BorderLayout.CENTER);   // Scroll 적용, JTextArea 갱신
		...
		textArea.setEditable(false);   // 직접 편집되지 않도록 설정
		textField.requestFocus();   // Focus를 준다.
	}
	...
	Socket 생성 
	입,출력 스트림 생성 
	ServerWorker Thread 생성 후 start 
	startUI() 
	 */
